...
import { Probe, Direction, isPlainObject } from './utils'
...
export default class PullDown {
  ...
  private checkPullDown() {
    ...
    this.scroller.scrollTo(x, stop, this.scroller.options.bounceTime, ease.bounce.fn)
  ...
  triggerPullToRefresh() {
    ...
    this.scroller.trigger('pullingDown')
    this.scroller.scrollTo(this.scroller.getCurrentPos().x, stop, this.scroller.options.bounceTime, ease.bounce.fn)
  }
}
