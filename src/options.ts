 ...
 *
 */
import { hasTransition, hasPerspective, hasTouch, Probe, EventPassthrough } from './utils'
// type
export type tap = 'tap' | ''
...
export default class Options {
  ...
  process() {
    this.translateZ = this.HWCompositing ? ' translateZ(0)' : ''

    this.useTransition = this.useTransition
